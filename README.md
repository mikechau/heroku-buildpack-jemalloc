...
or set `LD_PRELOAD=/app/vendor/jemalloc/lib/libjemalloc.so` in your
...
```bash
cd tmp/
curl -LO http://www.canonware.com/download/jemalloc/jemalloc-3.6.0.tar.bz2
...
tar zcf /tmp/jemalloc-3.6.0.tar.gz .
```
